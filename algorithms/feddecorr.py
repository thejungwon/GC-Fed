...
# ------------------------------
# FedDecorr regularization loss
# ------------------------------
# https://github.com/bytedance/FedDecorr/blob/master/loss.py
...
class FedDecorrClient:
    ...
    def __init__(self, client_id, data_loader, model_parameter, args):
        """
        Initialize a FedDecorrClient instance.
        ...
        self.feddecorr_coef = self.args.feddecorr_coef
...
class FedDecorr:
    ...
    def client_train(self, params):
        ...
        client = FedDecorrClient(client_id, data_loader, model_parameter, args)
        loss = client.train()
