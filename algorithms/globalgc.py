...
class GlobalGCClient:
    ...
    def __init__(self, client_id, data_loader, model_parameter, args):
        """
        Initialize a GlobalGCClient instance.
...
class GlobalGC:
    ...
    def aggregate_gradients(self, client_updates):
        ...
        for layer in aggregated_weight.keys():
            ...
            global_delta = torch.mean(layer_gradients, dim=0)
    ...
    def client_train(self, params):
        ...
        client = GlobalGCClient(client_id, data_loader, model_parameter, args)
        loss = client.train()
