...
class FedProxClient:
    ...
    def __init__(self, client_id, data_loader, model_parameter, args):
        """
        Initialize a FedProxClient instance.
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            for inputs, labels in self.data_loader:
                ...
                # Add proximal term
                # https://github.com/adap/flower/blob/a093c6d9de337b68de21978f2cc763a8506c2551/baselines/fedprox/fedprox/model.py#L115
                proximal_term = 0.0
                for w, w_t in zip(
                    self.model.parameters(), self.global_model_param.values()
                ):
                    proximal_term += ((w - w_t.to(self.args.device)) ** 2).sum()
...
class FedProx:
    ...
    def client_train(self, params):
        ...
        client = FedProxClient(client_id, data_loader, model_parameter, args)
        loss = client.train()
